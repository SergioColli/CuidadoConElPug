    ...
    if ($result && $result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            echo "<div class='product' 
                    ...
                    <h3>" . htmlspecialchars($row['nombre'], ENT_QUOTES) . "</h3>
                    <p>Precio: $" . $row['precio'] . "</p>
                    <p>Talla: " . htmlspecialchars($row['talla'], ENT_QUOTES) . "</p>
                    <p>Sexo: " . htmlspecialchars(ucfirst($row['sexo']), ENT_QUOTES) . "</p>
                    <p>Tipo: " . htmlspecialchars(ucfirst($row['tipo']), ENT_QUOTES) . "</p>
